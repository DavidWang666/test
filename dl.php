...
<div class="login-box">
	...
	<form name="f2" method="post" action="yz.php" onsubmit="return check()">
		<div class="name">
			<label>管理员账号：</label>
			<input type="text" name="name" value='<?php echo $uname; ?>' tabindex="1" autocomplete="off" />
		</div>
		<div class="password">
			<label>密  码：</label>
			<input type="password" name="pwd" maxlength="16" value='<?php echo $upwd; ?>' tabindex="2"/>
		</div>
		<div class="code">
			<label>验证码：</label>
			<input type="text" name="yzm" maxlength="4" id="code" tabindex="3"/>
			<div class="codeImg">
				<img src="yzm.php" onclick="javascript:this.src='yzm.php?time='+Math.random();" alt="看不清楚换一张" title="看不清楚换一张" style="cursor:pointer">
			</div>
		</div>
		<div class="remember">
			<input type="checkbox" id="remember" name="isrem" value="Remember" tabindex="4">
			<label>记住密码</label>
		</div>
		<div class="login">
...
<div class="screenbg">
	<ul>
		...
		<li><a href="javascript:;"><img src="images/bj/bjbj.jpg"></a></li>
	</ul>
</div>
